...
interface SaleTemplateNameBytesInterface extends ethers.utils.Interface {
  functions: {
...
export class SaleTemplateNameBytes extends BaseContract {
  ...
  interface: SaleTemplateNameBytesInterface;
