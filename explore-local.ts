...
import { FixedPriceSale__factory, FairSale__factory } from './utils/typechain-contracts'
// Utils
import {
...
*/
  ...
  {
    const { '4': saleStartDate, participantList } = await sales.fixedPriceSale.saleInvestorA.saleInfo()
