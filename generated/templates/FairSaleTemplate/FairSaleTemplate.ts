...
export class TemplateInitialized__Params {
  ...
  get orderCancelationPeriodDuration(): BigInt {
...
export class FairSaleTemplate extends ethereum.SmartContract {
  static bind(address: Address): FairSaleTemplate {
    return new FairSaleTemplate("FairSaleTemplate", address);
  }
