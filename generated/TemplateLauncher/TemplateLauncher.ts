...
export class TemplateLauncher extends ethereum.SmartContract {
  ...
  allowPublicTemplates(): boolean {
    let result = super.call('allowPublicTemplates', 'allowPublicTemplates():(bool)', [])

    return result[0].toBoolean()
  }

  try_allowPublicTemplates(): ethereum.CallResult<boolean> {
    let result = super.tryCall('allowPublicTemplates', 'allowPublicTemplates():(bool)', [])
    if (result.reverted) {
  ...
  try_getTemplate(_templateId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall('getTemplate', 'getTemplate(uint256):(address)', [
      ethereum.Value.fromUnsignedBigInt(_templateId)
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  getTemplateId(_template: Address): BigInt {
    let result = super.call('getTemplateId', 'getTemplateId(address):(uint256)', [
  ...
  try_getTemplateId(_template: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall('getTemplateId', 'getTemplateId(address):(uint256)', [
      ethereum.Value.fromAddress(_template)
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  launchedTemplate(param0: Address): TemplateLauncher__launchedTemplateResult {
    let result = super.call('launchedTemplate', 'launchedTemplate(address):(address,string)', [
      ethereum.Value.fromAddress(param0)
    ])

    return new TemplateLauncher__launchedTemplateResult(result[0].toAddress(), result[1].toString())
  }

  try_launchedTemplate(param0: Address): ethereum.CallResult<TemplateLauncher__launchedTemplateResult> {
    let result = super.tryCall('launchedTemplate', 'launchedTemplate(address):(address,string)', [
      ethereum.Value.fromAddress(param0)
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
    ...
    return ethereum.CallResult.fromValue(
      new TemplateLauncher__launchedTemplateResult(value[0].toAddress(), value[1].toString())
    )
  }

  participantListLaucher(): Address {
    let result = super.call('participantListLaucher', 'participantListLaucher():(address)', [])

    return result[0].toAddress()
  }

  try_participantListLaucher(): ethereum.CallResult<Address> {
    let result = super.tryCall('participantListLaucher', 'participantListLaucher():(address)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    let value = result.value
  ...
  templateVerified(param0: Address): boolean {
    let result = super.call('templateVerified', 'templateVerified(address):(bool)', [
      ethereum.Value.fromAddress(param0)
    ])
  ...
  try_templateVerified(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall('templateVerified', 'templateVerified(address):(bool)', [
      ethereum.Value.fromAddress(param0)
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
